<!--
{
  ...
  "identifier" : "/documentation/SwiftUITheming/GettingStarted",
...
> Note: Be sure to checkout <doc://dev.alexanderweiss.swiftui_theming/tutorials/MeetSwiftUITheming> for an interactive tutorial.
...
With color styles defined, implement a method to create a theme. Each theme requires to at least have a name and a color mapping. Depending on your needs you may need different mappings on different platforms since not all color [`ThemeColor`](/documentation/Theming/ThemeColor) variants are available on all platforms.
...
To enable theming in your app, inject a [`ThemeManager`](/documentation/Theming/ThemeManager) instance into your app’s scenes.
...
In order to test your themes in SwiftUI previews, you can either inject a [`ThemeManager`](/documentation/Theming/ThemeManager) or a [`Theme`](/documentation/Theming/Theme)
